    ...
    function stateConfig($stateProvider) {
        ...
        .state('pregunta', {
            ...
            data: {
                ...
                pageTitle: 'basketballOauth2Jhipster3App.pregunta.home.title'
            },
            views: {
                'content@': {
        ...
        .state('pregunta-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'basketballOauth2Jhipster3App.pregunta.detail.title'
            },
            views: {
                'content@': {
            ...
            resolve: {
                ...
                entity: ['$stateParams', 'Pregunta', function($stateParams, Pregunta) {
                    return Pregunta.get({id : $stateParams.id});
                }]
            }
        })
        .state('pregunta.new', {
