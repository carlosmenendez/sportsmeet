    ...
    function stateConfig($stateProvider) {
        ...
        .state('respuesta', {
            ...
            data: {
                ...
                pageTitle: 'basketballOauth2Jhipster3App.respuesta.home.title'
            },
            views: {
                'content@': {
        ...
        .state('respuesta-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'basketballOauth2Jhipster3App.respuesta.detail.title'
            },
            views: {
                'content@': {
            ...
            resolve: {
                ...
                entity: ['$stateParams', 'Respuesta', function($stateParams, Respuesta) {
                    return Respuesta.get({id : $stateParams.id});
                }]
            }
        })
        .state('respuesta.new', {
