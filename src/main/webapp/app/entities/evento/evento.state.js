    ...
    function stateConfig($stateProvider) {
        ...
        .state('evento', {
            ...
            data: {
                ...
                pageTitle: 'basketballOauth2Jhipster3App.evento.home.title'
            },
            views: {
                'content@': {
        ...
        .state('evento-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'basketballOauth2Jhipster3App.evento.detail.title'
            },
            views: {
                'content@': {
                    ...
                    resolve: {
                        entity: function () {
                            return {
                                ...
                                inicioLatitud: null,
                                inicioLongitud: null,
                                final_trayectoLatitud: null,
                                final_trayectoLongitud: null,
                                id: null
                            };
                        }
                    }
